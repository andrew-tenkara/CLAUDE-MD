...
def build_footer(rtk, hr):
    ...
    text.append(f"{rtk_saved + hr_comp:,.0f} tokens saved", style="bold green")
...
def build_layout(rtk, hr):
    ...
    if narrow:
        layout.split_column(
            ...
            Layout(build_rtk_panel(rtk, narrow=True), name="rtk", ratio=5),
            Layout(build_headroom_panel(hr, narrow=True), name="headroom", ratio=5),
        ...
        layout["stats"].split_column(
            Layout(build_rtk_panel(rtk, narrow=False), name="rtk", ratio=1),
            Layout(build_headroom_panel(hr, narrow=False), name="headroom", ratio=1),
        )
