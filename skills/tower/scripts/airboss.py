...
class AirBoss:
    ...
    def _build_kickoff_prompt(self, sitrep: str, worktree_info: str, deploy_script: Path) -> str:
        ...
        return (
            ...
            f"   cat {ctx._project_dir}/.sortie/sentinel-heartbeat.json | python3 -c \"import json,sys; d=json.load(sys.stdin); print('haiku_ok:', d['haiku_ok'], 'haiku_pid:', d.get('haiku_pid'))\"\n"
