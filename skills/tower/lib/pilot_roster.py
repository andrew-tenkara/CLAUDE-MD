...
def generate_personality_briefing(pilot: Pilot) -> str:
    return (
        ...
        "YOUR JOB:\n"
        "- Execute the directive you've been given — implement, fix, test, open a draft PR\n"
        "- Write code, run tests, commit changes, open draft PRs (`gh pr create --draft`) — never ready-for-review\n"
